package com.gsssoftwaresolution.java.utility.restfulservices.easyrestfulclient.tasks;

import java.util.concurrent.Callable;

import com.gsssoftwaresolution.java.utility.restfulservices.easyrestfulclient.factory.HttpClientFactory;
